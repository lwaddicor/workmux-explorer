...
The system SHALL serve both an interactive web UI and a machine-readable JSON HTTP API over localhost.

#### Scenario: Browse the dashboard in a browser
- **WHEN** the user opens the dashboard URL in a local browser
- **THEN** the web UI renders the cross-project worktree overview and its controls
